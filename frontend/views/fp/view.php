...
<?php
$this->title = Yii::t('app', 'ตรวจสอบแฟ้ม fp รายบุคคล');
$this->params['breadcrumbs'][] = ['label' => 'ตรวจสอบ 43 แฟ้ม', 'url' => ['oppp/index']];
$this->params['breadcrumbs'][] = ['label' => 'ตรวจสอบแฟ้ม fp', 'url' => ['fp/index']];
$this->params['breadcrumbs'][] = 'ตรวจสอบแฟ้ม fp รายบุคคล';
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover display">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>5</td>
                        <th scope="row"><code>FPTYPE [รหัสวิธีการคุมกำเเนิด]<font color="#04B404">*ใส่ข้อมูล</font></code></th>
                        <td><?php echo $chk['fptype']; ?></td>
                        <td><font color="red"><?php
                            if ($chk['fptype'] == NULL) {
                                echo Html::img('@web/images/no.png'), ' ', 'ตรวจสอบวิธีการคุมกำเเนิด [1 = ยาเม็ด , 2 = ยาฉีด , 3 = ห่วงอนามัย , 4 = ยาฝัง, 5 = ถุงยางอนามัย6 = หมันชาย, 7 = หมันหญิง]';
                            } else {
                                echo Html::img('@web/images/yes.png');
                            }
                            ?> 
                    ...
                    <tr>
                        <td>6</td>
                        <th scope="row"><code>FPPLACE [สถานที่รับบริการ]</code></th>
                        <td><?php echo $chk['fpplace']; ?></td>
                        <td><font color="red"><?php
                            if ($chk['fpplace'] == NULL) {
