...
<?php
$this->title = Yii::t('app', 'ตรวจสอบแฟ้ม icf รายบุคคล');
$this->params['breadcrumbs'][] = ['label' => 'ตรวจสอบ 43 แฟ้ม', 'url' => ['oppp/index']];
$this->params['breadcrumbs'][] = ['label' => 'ตรวจสอบแฟ้ม icf', 'url' => ['icf/index']];
$this->params['breadcrumbs'][] = 'ตรวจสอบแฟ้ม icf รายบุคคล';
