...
<?php
$this->title = Yii::t('app', 'ตรวจสอบแฟ้ม patient');
...
$this->params['breadcrumbs'][] = 'ตรวจสอบแฟ้ม patient';
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function($data) use($date1,$date2) {
                return  Html::a('<i class="glyphicon glyphicon-ok"></i>',['/person/view2' ,'id'=>$data['pid'], 'date1' => $date1, 'date2' => $date2,]);
            }// end value
        ]
]
]);
