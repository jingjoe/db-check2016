...
$this->params['breadcrumbs'][] = 'ตรวจสอบบริการแฟ้ม community_service';
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function($data) use($date1,$date2) {
                return  Html::a('<i class="glyphicon glyphicon-ok"></i>',['/communityserv/view' ,'id'=>$data['com_id'], 'date1' => $date1, 'date2' => $date2,]);
            }// end value
        ]
]
]);
