...
<div class="alert alert-primary">
  ...
  echo Html::a('ตรวจสอบบัญชี 3', ['epi/epi3'], ['class' => 'btn btn-warning']); 
  echo Html::a('ตรวจสอบบัญชี 4', ['epi/epi4'], ['class' => 'btn btn-warning']); 
  echo Html::a('ตรวจสอบบัญชี 5', ['epi/epi5'], ['class' => 'btn btn-warning']); 
  echo Html::a('ตรวจสอบ ER', ['epi/epier'], ['class' => 'btn btn-warning']);
  echo Html::a('ตรวจสอบ OPD', ['epi/epiopd'], ['class' => 'btn btn-warning']);  ?> <br>
