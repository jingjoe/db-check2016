...
<div class="alert alert-primary">
    <h4><font color="#FFFF00">ตัวชี้วัดเกณฑ์คุณภาพและผลงานบริการปฐมภูมิ QOF</font></h4>
    <h6><p><font color="#FFFFFF">อ้างอิงจากแนวทางและตัวชี้วัดเกณฑ์คุณภาพและผลงานบริการปฐมภูมิ (Quality and Outcome Framework: QOF) ปีงบประมาณ 2558 สำนักงานหลักประกันสุขภาพแห่งชาติ เขต 11 สุราษฏร์ธานี</font></p></h6>
</div>
...
<div class="panel panel-warning">
    ...
    <div class="panel-body">
        ...
        <div class="jumbotron">
            ...
            <?php echo Html::a('3.2 ร้อยละหน่วยบริการปฐมภูมิผ่านเกณฑ์ขึ้นทะเบียน <font color="red">ไม่สามารถเก็บข้อมูลได้</font>', ['qof/rep3_2']); ?>  <br>
        </div>
