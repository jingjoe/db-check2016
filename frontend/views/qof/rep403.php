...
$this->params['breadcrumbs'][] = 'เด็กนักเรียน ป. 1 ได้รับบริการเคลือบหลุมร่องฟันในฟันกรามแท้ซี่ที่หนึ่ง';
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function($model){
                return  Html::a(Html::encode($model['b']),['/qof/goal403' ,'id'=>$model['village_school_id']]);
            }// end value
        ],
        [
            'label' => 'ผลงาน  (คน)',
            ...
            'value' => function($model) use($date1,$date2){
                return  Html::a(Html::encode($model['a']),['/qof/result403' ,'id'=>$model['village_school_id'], 'date1' => $date1, 'date2' => $date2]);
            }// end value
        ]
    ]
]);
